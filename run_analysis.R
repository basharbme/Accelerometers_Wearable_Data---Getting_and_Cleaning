...
# ----- 2.
# We are extracting only the mean and standard deviation variable for each measurement,
# that is to say we select only the columns whose name contains the sequences of letters "mean" or "std"
...
# ----- 4.
# We are replacing the labels of the variables of the data set
# with descriptive variable names (according to the description of the researchers)
...
# ----- 5.
# We are creating a new data set grouping the measurements of the previous one by subject and activity
# and calculating the average values for each activity and each subject
Data <- tidy_data1 %>%
